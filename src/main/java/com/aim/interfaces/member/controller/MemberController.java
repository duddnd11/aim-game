package com.aim.interfaces.member.controller;
...
public class MemberController {
	...
	*/
	...
	public String memberModify(@Auth AuthUser user, Model model) {
		...
		MemberResult memberDto = (MemberResult) model.getAttribute("member");
	...
	public String mypage(@Auth AuthUser user, Model model) {
		...
		ScoreCountResult scoreCount = scoreService.memberScoreCount(user.getMemberId());
	...
	public String rank(@Auth AuthUser user, Model model, @PathVariable(value="page") int page) {
		Page<MemberResult> rankList = memberService.memberPvpRankList(page);
