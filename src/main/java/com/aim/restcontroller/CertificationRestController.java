...
import com.aim.form.FindPasswordForm;
import com.aim.security.UsernameEmailAuthenticationToken;
import com.aim.service.CertificationService;
...
public class CertificationRestController {
	...
	@PostMapping("")
	public ResponseEntity<Object> certifyCheck(@UserEmailAuth AuthUser user, @Validated FindPasswordForm findPasswordForm, BindingResult bindingResult) throws BindException{
